...
| P9.6 | GATE ⛔: e2e case per feature, offline + CI green, README + changelog in the same commit cycle (SPECS §13.6) — **PASSED**: 43/43 e2e green against the live stack (one case per feature); 158/158 offline tests green on a fresh db; all four CI jobs green locally — lint, 0 failed / 0 errors of 5 711 on a fresh database, contract-smoke, i18n — evidence in `docs/ci.md` | done | 2026-09-22 | 7760df7 |
...
| P9.6 | GATE: e2e per feature + offline/CI green + docs in-cycle | done ⛔ | 2026-09-22 | 7760df7 — evidence in `docs/ci.md` |
